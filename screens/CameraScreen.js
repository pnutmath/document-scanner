...
const SERVER_URL = 'https://qmfy8nacg4.execute-api.ap-south-1.amazonaws.com/prod/upload';
  ...
  onPictureSaved = async photo => {
    ...
    await fetch(SERVER_URL, {
      ...
      if (res.statusCode === 200) {
        ...
        Alert.alert(`Error: ${res.statusText}`);
      }
    }).catch((err) => {
...
const styles = StyleSheet.create({
  ...
  bottomBar: {
    paddingBottom: Platform.OS === 'ios' ? 25 : 5, // IsIPhoneX was here
    backgroundColor: 'transparent',
    alignSelf: 'flex-end',
    justifyContent: 'space-between',
    flex: 0.12,
